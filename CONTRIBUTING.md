...
Tests should be added to cover any changes or new features. These can be found in the `tests` folder. To run the Mini.test suite, [Make](https://www.gnu.org/software/make/) is required. Run `make test` from the repository root.
