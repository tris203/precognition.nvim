...
If you’re interested in adding custom motions to Precognition, take a look at [interface.lua](https://github.com/tris203/precognition.nvim/blob/main/lua/motions/interface.lua) for the available integration points.
