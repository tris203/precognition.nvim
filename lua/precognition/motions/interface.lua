...
---
---@field text_object_hints? fun(prefix: string, line_content: string, cursorcol: integer, linelen: integer): Precognition.TextObjectAnchor[], Precognition.RangePreview[]
---
local M = {}
